  ...
  return (
    <section className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4 xl:grid-cols-4">
      {metrics.map((metric) => (
        <article
          key={metric.label}
          className="rounded-2xl border border-white/10 bg-gradient-to-b from-zinc-900/50 to-zinc-950/80 p-4 shadow-lg ring-1 ring-white/5 sm:p-5"
        >
          ...
          <p className="mt-2 text-2xl font-semibold tracking-tight text-zinc-100 sm:mt-3 sm:text-3xl">
            {metric.value}
          </p>
